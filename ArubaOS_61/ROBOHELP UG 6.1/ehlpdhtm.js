...
function BsPopup_CreateDiv(nIndex)
{
	...
	strPopupDiv += "<IFRAME title=\"Popup Window\" ID='" + getPopupIFrameID(nIndex) + "' name='" + getPopupIFrameName(nIndex) + "' src = 'hostname.htm#XREF_40407_hostname' frameborder=0 scrolling=auto></IFRAME>";
	strPopupDiv += "</DIV></DIV>";
