...
$INDEXER_START = '/localhost/HERE/ArubaOS_61/ArubaOS_61_CLI/'; # re-index

# The base url of your site being indexed
# Be sure it corresponds to the $INDEXER_START directory (end with /)
$BASE_URL = 'http://localhost/HERE/ArubaOS_61/ArubaOS_61_CLI/';

# The url where ksearch.cgi is located
$SEARCH_URL = "http://localhost/HERE/search/ksearch.cgi";

# The full-path of the ksearch directory (end with /)
$KSEARCH_DIR = 'C:/xampp/htdocs/HERE/search/'; # re-index
...
@VALID_REFERERS = ("http://localhost/");
$INDEXER_URL = "http://localhost/search/indexer.cgi";
$PASSWORD = "root"; # required to access INDEXER.CGI
...
$LOG_SEARCH = 'localhost/search/database/search_log.txt';
